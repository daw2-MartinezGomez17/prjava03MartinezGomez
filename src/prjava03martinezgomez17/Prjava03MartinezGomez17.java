package prjava03martinezgomez17; 
import java.awt.*;        // using AWT containers and components 
import java.awt.event.*;  // using AWT events and listener interfaces 
import java.io.*;
 
// An AWT GUI program inherits the top-level container java.awt.Frame 
public class Prjava03MartinezGomez17 extends Frame implements ActionListener, WindowListener { 
   ...
   public Prjava03MartinezGomez17 () { 
   ...
   public static void main(String[] args) { 
      new Prjava03MartinezGomez17();  // Let the construct do the job 
   } 
